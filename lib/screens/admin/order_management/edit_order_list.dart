...
class EditOrderList extends StatefulWidget {
  ...
  @override
  EditOrderListState createState() => EditOrderListState();
}

class EditOrderListState extends State<EditOrderList> {
  ...
  void initState() {
    ...
    selectedDeliveryType = widget.orderData['deliveryType'];
    selectedPayment = widget.orderData['Payment'];
    totalPrice = widget.orderData['sale'];
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const AddEditTitleSection(title: 'Edit Order Details'),
                      ...
                      CustomButton(
                        onPressed: () async {
                          await updateInformation(
                            context: context,
                            targetWidget: const AdminOrderList(),
                            controllers: {
                              'items': items,
                              'sale': totalPrice,
